		...
		case 1:
			...
			case 1:
				...
				else
				{
					printf("-------------------------------------------------\n");
					printf("查找商品为：\n");
					printf("%3d%10s%10s%3d%10s%3d%3d%3d%3d",yz[i].num,yz[i].name,yz[i].phone,yz[i].home,yz[i].unite,yz[i].ele,yz[i].water,yz[i].hfee,&yz[i].wfee);
					printf("-------------------------------------------------\n");
				}
				break;
			case 2:
...
void output(yezhu yz[],int n)
{
	...
	printf("                              物业管理信息表                           \n");
	printf("----------------------------------------------------------------------\n");
	printf("业主编号  业主姓名  业主电话  业主房号  业主工作单位  用电量  用水量  物业费  水电费\n");
	for(i=0;i<n;i++)
		printf("%3d%10s%10s%3d%10s%3d%3d%3d%3d",yz[i].num,yz[i].name,yz[i].phone,yz[i].home,yz[i].unite,yz[i].ele,yz[i].water,yz[i].hfee,&yz[i].wfee);
	printf("----------------------------------------------------------------------\n");
}
	...
	else
	{
		do
		{
			...
			case 1:
				...
				{
					printf("请输入插入信息：业主编号  业主姓名  业主电话  业主房号  业主工作单位  用电量  用水量  物业费  水电费\n");
